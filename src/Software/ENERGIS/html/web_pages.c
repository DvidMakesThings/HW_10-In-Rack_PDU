...
const char control_html[] =
    ...
    "window.addEventListener('load', () =>{ updateStatus(); setInterval(updateStatus, 5000); "
    ...
    "id=\"power-8\">--</td></tr></table><br><button type=\"submit\" class=\"btn\">Apply "
    "Changes</button><button type=\"button\" class=\"btn btn-green\" onclick=\"setAll(true)\">All "
    "On</button><button type=\"button\" class=\"btn btn-red\" onclick=\"setAll(false)\">All "
    "Off</button></form><div class=\"status\"><p><strong>Internal Temperature:</strong><span "
    "id=\"internal-temperature\">--</span><span id=\"temp-unit\">°C</span></p><p><strong>System "
    "Status:</strong><span id=\"system-status\">--</span></p></div></main></div></body></html>\n";
