...
void print_network_information(wiz_NetInfo net_info)
{
    ...
    INFO_PRINT(" MAC         : %02X:%02X:%02X:%02X:%02X:%02X", net_info.mac[0], net_info.mac[1], net_info.mac[2], net_info.mac[3], net_info.mac[4], net_info.mac[5]);
    INFO_PRINT(" IP          : %d.%d.%d.%d", net_info.ip[0], net_info.ip[1], net_info.ip[2], net_info.ip[3]);
    INFO_PRINT(" Subnet Mask : %d.%d.%d.%d", net_info.sn[0], net_info.sn[1], net_info.sn[2], net_info.sn[3]);
    INFO_PRINT(" Gateway     : %d.%d.%d.%d", net_info.gw[0], net_info.gw[1], net_info.gw[2], net_info.gw[3]);
    INFO_PRINT(" DNS         : %d.%d.%d.%d", net_info.dns[0], net_info.dns[1], net_info.dns[2], net_info.dns[3]);
    INFO_PRINT("=============================================\n");
