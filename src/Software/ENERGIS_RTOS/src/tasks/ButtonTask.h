 ...
 * @brief FreeRTOS-based button scanner + debouncer header for ENERGIS.
 *
 * @version 1.0.0
 * @date 2025-11-06
 * @details
 ...
 *      PLUS  -> move selection RIGHT (wrap)
 *      MINUS -> move selection LEFT  (wrap)
 *      SET short -> toggle selected relay
 *      SET long  -> clear error LED (setError(false))
